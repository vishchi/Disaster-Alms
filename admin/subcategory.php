...
if(isset($_POST['submit']))
{
	...
	$subcat=$_POST['Disaster'];
	$expect=$_POST['expected'];
$sql=mysqli_query($con,"insert into subcategory(categoryid,subcategory,updationDate) values('$category','$subcat',$expect)");
...
<div class="control-group">
<label class="control-label" for="basicinput">Disaster Name</label>
<div class="controls">
<input type="text" placeholder="Enter Disaster Name"  name="Disaster" class="span8 tip" required>
</div>
</div>

<div class="control-group">
<label class="control-label" for="basicinput">Expected Expenditure (in Cr) :</label>
<div class="controls">
<input type="text" placeholder="Amount in RS"  name="expected" class="span8 tip" required>
</div>
</div>
